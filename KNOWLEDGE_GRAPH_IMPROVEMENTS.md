...
Все Example и Method сейчас дифференцированы только по `difficulty_level/difficulty` (числовая сложность 0–3). Нет разделения по **когнитивному уровню** — типу мыслительной операции, которую требует задание.

Таксономия Блума определяет 6 уровней когнитивных операций (от простого к сложному) TODO: подумать над бесшовной интеграцией в текущей флоу микро уроков (i do - we do - you do - reflection(optional)):
