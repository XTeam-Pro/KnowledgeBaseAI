...
tags_metadata = [
    {
        "name": "Engine",
        "description": "Unified core engine for Roadmap, Graph traversal, and Reasoning.",
    },
    {
...
* **Unified Engine**: используйте эндпойнты `/v1/engine/*` для работы с графом (дорожная карта, вопросы, навигация).
